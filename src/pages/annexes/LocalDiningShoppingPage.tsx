    ...
    <Container maxWidth="lg">
      ...
      <Paper elevation={2} sx={{ p: 3, mb: 4 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
          ...
          <Typography variant="h5">Dining Options</Typography>
        </Box>
        <Divider sx={{ mb: 3 }} />
        ...
        <Grid container spacing={3} sx={{ mb: 4 }}>
          <Grid item xs={12} md={4}>
            <Paper elevation={1} sx={{ p: 2, height: '100%' }}>
              ...
              <Typography variant="body2">
                Popular seafood restaurant with Cajun-inspired dishes. Known for their&nbsp;gumbo.
                and fresh fish.
              </Typography>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} md={4}>
            <Paper elevation={1} sx={{ p: 2, height: '100%' }}>
              ...
              <Typography variant="body2">
                Authentic Vietnamese restaurant known for their delicious pho and banh
                mi&nbsp;sandwiches
              </Typography>
            </Paper>
          </Grid>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={4}>
            <Paper elevation={1} sx={{ p: 2, height: '100%' }}>
              ...
              <Typography variant="body2">
                Upscale Oaxacan cuisine by award-winning chef Hugo Ortega. Known for mole dishes and
                creative cocktails.
              </Typography>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} md={4}>
            <Paper elevation={1} sx={{ p: 2, height: '100%' }}>
              ...
              <Typography variant="body2">
                Located in Discovery Green park, offering upscale American cuisine with a focus on
                local ingredients.
              </Typography>
            </Paper>
          </Grid>
      ...
      <Paper elevation={2} sx={{ p: 3, mb: 4 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
          ...
          <Typography variant="h5">Shopping Destinations</Typography>
        </Box>
        <Divider sx={{ mb: 3 }} />
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
            <Paper elevation={1} sx={{ p: 2, height: '100%' }}>
              ...
              <Typography variant="body2" paragraph>
                Houston&apos;s premier shopping destination with over 400 stores, including luxury
                brands, department stores, and specialty shops. Also features an ice skating rink
                and numerous restaurants.
              </Typography>
              <Typography variant="body2">Distance from hotel: ~15 minutes by car</Typography>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <Paper elevation={1} sx={{ p: 2, height: '100%' }}>
              ...
              <Typography variant="body2">Distance from hotel: ~10 minutes by car</Typography>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <Paper elevation={1} sx={{ p: 2, height: '100%' }}>
              ...
              <Typography variant="body2">Distance from hotel: ~30 minutes by car</Typography>
            </Paper>
          </Grid>
        </Grid>
      </Paper>
      ...
      <Paper elevation={2} sx={{ p: 3 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
          ...
          <Typography variant="h5">Coffee Shops & Quick Bites</Typography>
        </Box>
        <Divider sx={{ mb: 3 }} />
